...
- **Actionable insights**: If there's a clear trend, suggest potential implications (e.g., "BTC is showing strong momentum above resistance; watch for a breakout").
    ...
    try {
      const res = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyBvY2E5iSzi9M_O8GB6fgxmb3Dy9gvREKo", {
        method: "POST",
